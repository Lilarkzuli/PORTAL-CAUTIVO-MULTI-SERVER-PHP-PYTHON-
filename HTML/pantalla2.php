...
<body>
    ...
    <div class="container">
        ...
        <a class="button" href='borrartodo.php'>borrar todo</a>
        <?php
            ...
            if ($datos) {
                ...
                while ($fila = mysqli_fetch_assoc($datos)) {
                    ...
                    echo '<td><a href="bloquearpersonas.php?mac='.  $fila['mac'] . '"> <span class="material-symbols-outlined"> person_remove </span> </a></td>';
